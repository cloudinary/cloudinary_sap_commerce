...
public class DefaultBulkUploadApiService implements BulkUploadApiService {
    ...
    public void bulkAssetUpload(BulkUploadRequestData bulkUploadRequestData, String baseSiteId) {
        ...
        bulkUploadRequestData.getProductMediaAssest().forEach(bulkUpload -> {
            ...
            if (stagedProduct != null) {
                if (org.apache.commons.collections4.CollectionUtils.isEmpty(stagedProduct.getGalleryImages())) {
                    ...
                    if (!CollectionUtils.isEmpty(mediaContainersData)) {
                        ...
                        if (org.apache.commons.collections4.CollectionUtils.isNotEmpty(stagedProduct.getGalleryImages())) {
    ...
    protected void UpdateTagOnProduct(CloudinaryConfigModel cloudinaryConfigModel, CloudinaryProductAssestData bulkUpload, String publicId, String cloudinaryResourceType) {
        try {
    ...
    protected ProductModel getStagedProduct(List<ProductModel> productModels, String baseSiteId) {
        for (ProductModel productmodel : productModels) {
            ...
            if (org.apache.commons.collections4.CollectionUtils.isNotEmpty(stagedProducts)) {
    ...
    protected void updateMasterMedia(MediaContainerData data, ProductModel product) {
    ...
    protected MediaContainerModel createMediaContainer(MediaContainerData md, ProductModel product) {
    ...
    protected MediaModel createMediaContainerAndAssociateWithProduct(ProductModel stagedProduct, List<MediaContainerData> mediaContainers) {
    ...
    protected MediaModel createMasterMedia(MediaContainerData data, ProductModel product) {
    ...
    protected MediaModel updateMasterMedia(MediaContainerData data, MediaModel media) {
