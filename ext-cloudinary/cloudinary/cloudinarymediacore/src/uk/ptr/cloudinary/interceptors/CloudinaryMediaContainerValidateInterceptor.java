...
public class CloudinaryMediaContainerValidateInterceptor implements ValidateInterceptor<MediaContainerModel> {
    ...
    protected MediaModel getMasterMedia(Collection<MediaModel> medias) {
    ...
    protected void updateTagOnProduct(String cloudinaryUrl, String productCode, MediaModel mediaModel) {
        try {
