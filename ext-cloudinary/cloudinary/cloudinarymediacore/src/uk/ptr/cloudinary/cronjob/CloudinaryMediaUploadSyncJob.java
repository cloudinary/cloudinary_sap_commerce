...
public class CloudinaryMediaUploadSyncJob extends AbstractJobPerformable<CloudinaryMediaUploadSyncJobModel> {
    ...
    protected void updateMedia(CloudinaryConfigModel cloudinaryConfigModel, MediaContainerModel mediaContainer) {
    ...
    protected void updateOnDemandMedia(MediaContainerModel mediaContainerModel, List<MediaFormatModel> mediaFormatModels) {
    ...
    protected MediaModel getLargestImage(MediaContainerModel mediaContainerModel) {
        int imageSize = 0;
