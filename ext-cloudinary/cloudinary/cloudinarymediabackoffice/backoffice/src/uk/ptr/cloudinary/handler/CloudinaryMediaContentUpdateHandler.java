        ...
        try {
            ...
            if (responseData == null) {
                ...
                if (StringUtils.isNotEmpty(cloudinaryCname)) {
                    ...
                    mediaToUpdate.setURL(uploadApiService.getSecureUrl(responseData));
                }
                ...
                mediaToUpdate.setCloudinaryVersion(responseData.getVersion());
                mediaToUpdate.setCloudinaryMediaFormat(responseData.getFormat());
                mediaToUpdate.setCloudinaryTransformation(uploadApiService.getTransformationForDerivedMedia(responseData));
