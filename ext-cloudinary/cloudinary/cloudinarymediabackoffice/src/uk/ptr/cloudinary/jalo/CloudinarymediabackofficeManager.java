...
public class CloudinarymediabackofficeManager extends GeneratedCloudinarymediabackofficeManager
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(CloudinarymediabackofficeManager.class.getName());
	 ...
	 */
	public static CloudinarymediabackofficeManager getInstance()
	{
		return (CloudinarymediabackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CloudinarymediabackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CloudinarymediabackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CloudinarymediabackofficeManager called.");
		}
	}
