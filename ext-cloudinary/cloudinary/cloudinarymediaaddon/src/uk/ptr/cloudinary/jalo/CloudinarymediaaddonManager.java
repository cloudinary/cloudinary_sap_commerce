...
/**
 * This is the extension manager of the Cloudinarymediaaddon extension.
 */
public class CloudinarymediaaddonManager extends GeneratedCloudinarymediaaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CloudinarymediaaddonManager.class.getName());
	 ...
	 */
	public static CloudinarymediaaddonManager getInstance()
	{
		return (CloudinarymediaaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CloudinarymediaaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CloudinarymediaaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CloudinarymediaaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CloudinarymediaaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CloudinarymediaaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
