...
public class DefaultCloudinarymediafacadesService implements CloudinarymediafacadesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCloudinarymediafacadesService.class);
	...
	{
		return DefaultCloudinarymediafacadesService.class.getResourceAsStream("/cloudinarymediafacades/sap-hybris-platform.png");
	}
