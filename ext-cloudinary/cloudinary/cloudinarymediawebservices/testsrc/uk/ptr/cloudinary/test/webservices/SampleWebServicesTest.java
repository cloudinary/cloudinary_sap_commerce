...
import static uk.ptr.cloudinary.constants.CloudinarymediawebservicesConstants.*;


@NeedsEmbeddedServer(webExtensions = { CloudinarymediawebservicesConstants.EXTENSIONNAME, "oauth2" })
@IntegrationTest
